...
class DataSortingBoxLauncher(QMainWindow):
    ...
    def __init__(self):
        ...
        self.tools = {
            "multimedia": {
                ...
                "icon": "", 
                "implemented": True, 
                "description": "全メディアを横断解析\n形式・容量・構造を一括で可視化し、全体像をすばやく把握",
                "category": "ultimate",
                "priority": 1
            },
            ...
            "3d": {
                ...
                "icon": "", 
                "implemented": True, 
                "description": "3Dモデル専門解析\nメッシュ・頂点・材質情報を確認し、品質チェックを支援",
                "category": "specialist",
                "priority": 2
            },
            ...
            "analyzer": {
                ...
                "icon": "", 
                "implemented": True, 
                "description": "フォルダ構造の統計解析\nファイル数・容量・拡張子内訳を可視化し、整理方針を明確化",
                "category": "basic",
                "priority": 3
            }
        }
    ...
    def create_header_bar(self):
        ...
        subtitle = QLabel("データフロー解析スイート v2.0")
    ...
    def create_welcome_section(self):
        ...
        welcome_text = QLabel("実務向けマルチメディア解析ハブ")
        welcome_text.setObjectName("welcomeText")
        layout.addWidget(welcome_text)
        
        description = QLabel("Dataflux はファイル整理と解析を 1 画面で完結できる運用ツールです。\nフォルダ全体の俯瞰、形式別の深掘り、作業用の切り分けを高速に行えます。")
    ...
    def apply_modern_theme(self):
        ...
        */
        ...
        /* Folder AnalysisはPro Toolsグリッド内に配置 */
    ...
    def launch_tool(self, tool_id: str):
        ...
        try:
            ...
            if tool_id == "analyzer":
                ...
                window.show()
                # 開発モード時は読み込まれたパスを通知
                if os.getenv("DATAFLUX_DEV") == "1":
                    QMessageBox.information(self, "デバッグ情報",
                        f"image_analyzer.py: {ui_qt.image_analyzer.__file__}")
                ...
                if os.getenv("DATAFLUX_DEV") == "1":
                    QMessageBox.information(self, "デバッグ情報",
                        f"multimedia_analyzer.py: {ui_qt.multimedia_analyzer.__file__}")
